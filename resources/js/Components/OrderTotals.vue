        ...
        <div class="shadow-md rounded sm:my-2">
            <div class="flex flex-col items-center space-y-4 py-6 bg-gray-700">
                <div class="flex space-x-4">
                    ...
                    <span class="text-yellow-500">{{$filters.formatCurrency(newSubtotal)}}</span>
            ...
            <div class="bg-gray-300 px-4 py-6">
                <div>
                    ...
                    <div class="flex justify-between bg-white px-4 py-2 mt-4">
                        <!-- cartCount: Middleware->HandleInertiaRequests -->
                    ...
                    <div class="flex justify-between px-4" v-if="code">
                ...
                <div class="bg-gray-300 px-4">
                    <div>
                        <div class="flex flex-col items-center bg-white px-4 py-4 mt-2">
                            <input type="text" class="w-full" placeholder="Enter Promo Code Here" v-model="form.coupon_code"><!-- vue data() property -->
                            <span class="text-md text-red-600 mt-2" v-if="$page.props.errors.message">
                                {{ $page.props.errors.message }}
                            </span>
                        </div>
                        <div class="text-center mt-4">
                            <gray-button as="button" class="text-sm">Apply</gray-button>
                        </div>
                    </div>
                </div>
            </form>
...
export default defineComponent({
    props: ['taxRate', 'subtotal', 'tax', 'total', 'code', 'discount', 'newSubtotal'],
    components: {
        Link,
        YellowButton,
        GrayButton,
