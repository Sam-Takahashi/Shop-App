            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="flex-shrink-0 flex items-center">
                        <Link :href="route('welcome')" class="font-mont block w-auto hover:text-yellow-500 transition">
                            Metis Shop
                        </Link>
                    </div>
                </div>
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    ...
                    <div class="ml-3 relative">
                        <div class="flex items-center space-x-3 relative">
                            <Link href="#" class="hover:text-yellow-500 transition" v-if="$page.props.user">
                                Dashboard
                            </Link>
                            <template v-else>
